...
const EditRoute = (props: Props) => {
  return (
    <form method="post" action="/api/routes/edit" encType='application/json' className='w-full flex flex-col items-center align-middle justify-center bg-gray-300 dark:bg-gray-900 dark:border dark:border-white p-2 rounded-lg' >
      <h2 className='font-semibold'>Edit route: {props.path}</h2>
      <div className="w-full flex md:flex-row flex-col items-center align-middle justify-center mx-auto">
        <fieldset className='hidden'>
          ...
          <input id="path" type="text" name="path" placeholder='Enter a Path' className='md:mr-4 md:w-auto w-full px-2 py-1 rounded-lg dark:bg-black dark:text-white' value={props.path} />
        </fieldset>
